      		...
      		<h3>Student</h3>	
				...
				<c:forEach items="${branch}" var="br">
					<tr>
						...
						<td>${br.specialisation}</td>
						<td>${br.course_name}</td>
						<td><a href="<c:url value='/editBranch/${br.id}' />" >Edit</a></td>
						<td><a href="<c:url value='/deleteBranch/${br.id}' />" >Delete</a></td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
...
<div class="dropdown-container">
 <a href="faculty_view"><i class="fa fa-fw fa-cirlce"></i>List</a>
</div>
<button class="dropdown-btn"><i class="fa fa-fw fa-user"></i>Student
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
    <a href="allstudent_view"><i class="fa fa-fw fa-cirlce"></i>List</a>
</div>
...
<button class="dropdown-btn"><i class="fa fa-fw fa-user"></i>Course
  ...
  <div class="dropdown-container">
    <a href="course"><i class="fa fa-fw fa-cirlce"></i>List</a>
     <a href="add_course"><i class="fa fa-fw fa-cirlce"></i>Add</a>
</div>
<button class="dropdown-btn"><i class="fa fa-fw fa-user"></i>Branch
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
    <a href="branch"><i class="fa fa-fw fa-cirlce"></i>List</a>
     <a href="add_branch"><i class="fa fa-fw fa-cirlce"></i>Add</a>
</div>
<button class="dropdown-btn"><i class="fa fa-fw fa-user"></i>Subject
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
    <a href="subject"><i class="fa fa-fw fa-cirlce"></i>List</a>
     <a href="add_subject"><i class="fa fa-fw fa-cirlce"></i>Add</a>
</div>
</div>
  <script>
