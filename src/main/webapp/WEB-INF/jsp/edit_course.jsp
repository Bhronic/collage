...
<div class="main">
  <h3>Details</h3>
   <form commandname="course" action="/College_MAnagement_System/updateCourse" method="POST" >
  ...
  <input type="hidden" name="course_id" value="${course.course_id }" />
    ...
    <input class="w3-input w3-border" type="text" name="course_name" value="${course.course_name }" >
    <br>
   </div>
