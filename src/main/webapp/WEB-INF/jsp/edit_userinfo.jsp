...
<div class="main">
  <h3>Details</h3>
  <form commandname="user" action="/College_MAnagement_System/update" method="POST" >
 ...
 <input type="hidden" value="${user.security_question}" name="security_question">
  ...
  <div class="w3-half">
    ...
    <br>
    <label>Course</label>
<select class="w3-input w3-border"   name="faculty_name">
   
       <c:forEach var="f" items="${allcourse}">
  ...
  <div class="w3-half">
    ...
    <br>
     ...
     <select class="w3-input w3-border"   name="role_type">
       <option value="${user.role_type}">${user.role_type}</option>
    ...
    <br>
    <label>Branch</label>
    <input class="w3-input w3-border" type="text" name="branch" value="${user.branch}">
    <br>
