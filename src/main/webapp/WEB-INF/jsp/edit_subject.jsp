...
<div class="main">
  <h3>Details</h3>
   <form commandname="subject" action="/College_MAnagement_System/updateSubject" method="POST" >
  ...
  <input type="hidden" name="id" value="${subject.id }" />
    ...
    <input class="w3-input w3-border" type="text" name="subject_id" value="${subject.subject_id}" >
    <br>
    
    <label>Subject Name</label>
    <input class="w3-input w3-border" type="text" name="subject_name" value="${subject.subject_name }" >
    <br>
    <label>Maximum External Marks</label>
    <input class="w3-input w3-border" type="text" name="external_marks" value="${subject.external_marks}"  >
    <br>
    <label>Maximum Internal Marks</label>
    <input class="w3-input w3-border" type="text" name="internal_marks"  value="${subject.internal_marks}" >
    <br>
    <label>Credit</label>
    <input class="w3-input w3-border" type="text" name="credit" value="${subject.credit}"  >
    <br>
   </div>
   <div class="w3-half">
     
    <label>Course</label>
    <input class="w3-input w3-border" type="text" name="course" value="${subject.course}" >
    <br>
	<label>Branch</label>
    <input class="w3-input w3-border" type="text" name="branch" value="${subject.branch}" >
    <br>
    <label>Specialisation</label>
    <input class="w3-input w3-border" type="text" name="specialisation" value="${subject.specialisation}" >
    <br>
    <label>Semester</label>
    <input class="w3-input w3-border" type="text" name="semester" value="${subject.semester}" >
    <br>
   </div>
