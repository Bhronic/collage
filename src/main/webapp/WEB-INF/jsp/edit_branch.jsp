...
<div class="main">
  <h3>Details</h3>
   <form commandname="branch" action="/College_MAnagement_System/updateBranch" method="POST" >
  ...
  <input type="hidden" name="id" value="${branch.id }" />
   <label>Branch Name</label>
    <input class="w3-input w3-border" type="text" name="branch_name" value="${branch.branch_name }" >
    <br>
    <label>Specialization</label>
    <input class="w3-input w3-border" type="text" name="specialisation" value="${branch.specialisation }" >
    <br>
    <label>Course Name</label>
    <input class="w3-input w3-border" type="text" name="course_name" value="${branch.course_name}" >
    <br>
   </div>
