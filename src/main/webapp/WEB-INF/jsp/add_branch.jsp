...
<div class="main">
 ...
 <div class="w3-row-padding">
  ...
  <label>Branch Name</label>
    <input class="w3-input w3-border" type="text" name="branch_name"  >
    <br>
    <label>Specialization</label>
    <input class="w3-input w3-border" type="text" name="specialisation"  >
    <br>
    <label>Course Name</label>
    <input class="w3-input w3-border" type="text" name="course_name"  >
    <br>
   </div>
